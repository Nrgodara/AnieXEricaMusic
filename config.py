...
BOT_TOKEN = getenv("BOT_TOKEN","6674525999:AAEdPCxpdz2k8XY1VLSyAdeNMV3I4Wfsvv8")
MONGO_DB_URI = getenv("MONGO_DB_URI", "")
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", "9999"))
LOGGER_ID = int(getenv("LOGGER_ID", "-1002082157755"))
BOTADDLOGS = int(getenv("BOTADDLOGS", "-1002082157755")) # LOGGER_ID Id Also Use No Problem
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Mahi_Botz")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/mr_mahiji")

...
OWNER_ID = int(getenv("OWNER_ID", 1280494242))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Nrgodara/AnieXEricaMusic",
)
...
TG_VIDEO_FILESIZE_LIMIT = int(getenv("TG_VIDEO_FILESIZE_LIMIT", 5242880000000))
